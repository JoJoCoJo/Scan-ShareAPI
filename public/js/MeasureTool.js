  ...
  _createClass(MeasureTool, [{
    ...
    value: function _init() {
      if (this._options.contextMenu) {
        ...
        this._startElementNode = this._contextMenu.addItem("Medir distancia", true, this.start, this);
        this._endElementNode = this._contextMenu.addItem("Limpiar", false, this.end, this);
